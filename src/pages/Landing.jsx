...
export default function Landing() {
  ...
  const features = [
    { icon: Inbox, title: t.features[0].title, desc: t.features[0].desc, gradient: 'from-blue-500 to-blue-600', bg: 'bg-blue-50' },
    { icon: CalendarCheck, title: t.features[1].title, desc: t.features[1].desc, gradient: 'from-purple-500 to-purple-600', bg: 'bg-purple-50' },
    { icon: Wallet, title: t.features[2].title, desc: t.features[2].desc, gradient: 'from-emerald-500 to-emerald-600', bg: 'bg-emerald-50' },
    { icon: Brush, title: t.features[3].title, desc: t.features[3].desc, gradient: 'from-amber-500 to-amber-600', bg: 'bg-amber-50' },
    { icon: Send, title: t.features[4].title, desc: t.features[4].desc, gradient: 'from-cyan-500 to-cyan-600', bg: 'bg-cyan-50' },
    { icon: FileSignature, title: t.features[5].title, desc: t.features[5].desc, gradient: 'from-rose-500 to-rose-600', bg: 'bg-rose-50' }
  ];
